    ...
    <>
      ...
      <StyledContact>
        ...
        <ContactContainer>
          ...
          <ContactSubtitle>
            Bukhara Hotels is provided by{" "}
            <ContactLink to="https://www.advantour.com/">Advantour</ContactLink>
            . Please do not hesitate to contact us at:
          </ContactSubtitle>
          <ContactContentContainer>
            <ContactContent>
              <ContactHighlightText>Advantour Uzbekistan</ContactHighlightText>
              <ContactAddressContainer>
                <ContactAddress>
                  <ContactImage src="../images/home.svg" alt="" /> Mirobod
                  kochasi-1, 47A <br /> Tashkent, Uzbekistan
                </ContactAddress>
                <ContactAddress>
                  <ContactImage src="../images/phone-call.svg" alt="" /> +998 78
                  1503020
                  <br /> <ContactImage
            ...
            <ContactForm>
              <ContactText>
                Please fill out and send the following form to contact us via
                email. Our consultants will reply to your enquiry as soon as
                possible.
              </ContactText>
              <ContactInput placeholder="Name" type="text" />
              <ContactInput placeholder="Email" type="email" />
              <ContactTextareaComments placeholder="Comments" />
              <ContactButton>Send your comments</ContactButton>
            </ContactForm>
          </ContactContentContainer>
        </ContactContainer>
      </StyledContact>
